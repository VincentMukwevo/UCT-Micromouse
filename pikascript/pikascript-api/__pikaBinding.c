...
#ifndef PIKA_MODULE_UCT_MOUSE_DISABLE
void uct_mouse_MouseMethod(PikaObj *self, Args *_args_){
    Arg* res = uct_mouse_Mouse(self);
    method_returnArg(_args_, res);
}
method_typedef(
    uct_mouse_Mouse,
...
class_def(uct_mouse){
    __BEFORE_MOETHOD_DEF
    constructor_def(uct_mouse_Mouse, 229588462),
};
...
#ifndef PIKA_MODULE_UCT_MOUSE_DISABLE
void uct_mouse_Mouse_get_tof_lMethod(PikaObj *self, Args *_args_){
    int res = uct_mouse_Mouse_get_tof_l(self);
    method_returnInt(_args_, res);
}
method_typedef(
    uct_mouse_Mouse_get_tof_l,
    "get_tof_l", ""
);

void uct_mouse_Mouse_get_tof_rMethod(PikaObj *self, Args *_args_){
    int res = uct_mouse_Mouse_get_tof_r(self);
    method_returnInt(_args_, res);
}
method_typedef(
    uct_mouse_Mouse_get_tof_r,
    "get_tof_r", ""
);

void uct_mouse_Mouse_set_pwmMethod(PikaObj *self, Args *_args_){
    int left = args_getInt(_args_, "left");
    int right = args_getInt(_args_, "right");
    uct_mouse_Mouse_set_pwm(self, left, right);
}
method_typedef(
    uct_mouse_Mouse_set_pwm,
    "set_pwm", "left,right"
);

void uct_mouse_Mouse_tickMethod(PikaObj *self, Args *_args_){
    uct_mouse_Mouse_tick(self);
}
method_typedef(
    uct_mouse_Mouse_tick,
    "tick", ""
);

class_def(uct_mouse_Mouse){
    __BEFORE_MOETHOD_DEF
    method_def(uct_mouse_Mouse_set_pwm, 204148292),
    method_def(uct_mouse_Mouse_get_tof_l, 1301696792),
    method_def(uct_mouse_Mouse_get_tof_r, 1301696798),
    method_def(uct_mouse_Mouse_tick, 2090760016),
};
class_inhert(uct_mouse_Mouse, TinyObj);

PikaObj *New_uct_mouse_Mouse(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, uct_mouse_Mouse);
    return self;
}

Arg *uct_mouse_Mouse(PikaObj *self){
    return obj_newObjInPackage(New_uct_mouse_Mouse);
}
#endif
