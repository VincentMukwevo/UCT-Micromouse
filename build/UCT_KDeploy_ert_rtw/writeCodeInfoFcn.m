% Autogenerated file: Sun Jun 14 13:53:00 2026
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("UCT_KDeploy",pwd);
...
wr.fFullModel.componentInterface.Parameters;
    ...
    % Matrix Type
    CodeDescType_32_R0_V0_C0 = coder.descriptor.types.Matrix(wr.fMF0Model);
    CodeDescType_32_R0_V0_C0.BaseType   = CodeDescType_1_R0_V0_C0;
        CodeDescType_32_R0_V0_C0.Dimensions = [1,1];
            CodeDescType_32_R0_V0_C0.updateSymbolicPropertiesToMatchDims();
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'UCT_KDeploy.h';
    func_Initialize_Prototype.SourceFile = 'UCT_KDeploy.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'UCT_KDeploy_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'UCT_KDeploy.h';
    func_OutputUpdate_Prototype.SourceFile = 'UCT_KDeploy.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'UCT_KDeploy_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'UCT_KDeploy.h';
    func_Terminate_Prototype.SourceFile = 'UCT_KDeploy.c';
    ...
    time_terminate = wr.fFullModel.componentInterface.TimingProperties(getIndexFromTimingInternalId(wr.fFullModel.componentInterface.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_terminate;
                func_Terminate_Prototype.Name = ['UCT_KDeploy_terminate'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_UCT_KDeploy_T';
        ...
        CoderDescVar_RTModel.Identifier = 'UCT_KDeploy_M_';
        CoderDescVar_RTModel.Type = CodeDescPtrtype_RTModel_1_0.BaseType;
        CoderDescVar_RTModel.VarOwner = 'UCT_KDeploy';
            
            CoderDescVar_RTModel.DeclarationFile = 'UCT_KDeploy.h';
            CoderDescVar_RTModel.DefinitionFile  = 'UCT_KDeploy.c';
        ...
        % Pointer Variable: CodeDescPtrVar_RTModel
            ...
            CodeDescPtrVar_RTModel.Identifier      = 'UCT_KDeploy_M';
            CodeDescPtrVar_RTModel.TargetVariable = CoderDescVar_RTModel;
            
        CodeDescPtrVar_RTModel.VarOwner = 'UCT_KDeploy';
            CodeDescPtrVar_RTModel.DeclarationFile = 'UCT_KDeploy.h';
            CodeDescPtrVar_RTModel.DefinitionFile = 'UCT_KDeploy.c';
    ...
    % Matrix Type
    Type_32_R0_V0_C0 = coder.types.Matrix;
    Type_32_R0_V0_C0.BaseType   = Type_1_R0_V0_C0;
        Type_32_R0_V0_C0.Dimensions = [1,1];
    ...
    time_terminate = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        ...
        Var_RTModel.Identifier = 'UCT_KDeploy_M_';
        Var_RTModel.Type = Ptrtype_RTModel_1_0.BaseType;
        Var_RTModel.Owner = 'UCT_KDeploy';
            
            Var_RTModel.DeclarationFile = 'UCT_KDeploy.h';
            Var_RTModel.DefinitionFile  = 'UCT_KDeploy.c';


        % Pointer Variable: PtrVar_RTModel

            PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'UCT_KDeploy_M', Var_RTModel);
            
        PtrVar_RTModel.Owner = 'UCT_KDeploy';
            PtrVar_RTModel.DeclarationFile = 'UCT_KDeploy.h';
            PtrVar_RTModel.DefinitionFile = 'UCT_KDeploy.c';
